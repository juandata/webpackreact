...
var _inputsTodo = __webpack_require__(29);

var _ProductTable = __webpack_require__(36);

var _ProductTableEx = __webpack_require__(44);

var _learningReactJSX = __webpack_require__(46);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement(_inputsTodo.InputTodo, null),
        _react2.default.createElement(_ProductTable.ProductTable, null),
        _react2.default.createElement(_ProductTableEx.FilterableProductTable, { products: PRODUCTS }),
        _react2.default.createElement(
          "h1",
          null,
          "Learning advanced react below: "
        ),
        _react2.default.createElement(_learningReactJSX.EscogeColorAzul, null),
        _react2.default.createElement(
          "div",
          null,
          _react2.default.createElement(
          ...
          _react2.default.createElement(_learningReactJSX.CustomTextInput, null),
          _react2.default.createElement(_learningReactJSX.NameForm, null),
          _react2.default.createElement(
            "h1",
            null,
            "Accesing a file with refs"
          ),
          _react2.default.createElement(_learningReactJSX.FileInput, null)
        ),
        _react2.default.createElement(_learningReactJSX.HandlingPortals, null)
      );
    }
  }]);
...
var _todoApp = __webpack_require__(34);
...
var InputTodo = exports.InputTodo = function (_Component) {
  _inherits(InputTodo, _Component);

  function InputTodo(props) {
    _classCallCheck(this, InputTodo);

    var _this = _possibleConstructorReturn(this, (InputTodo.__proto__ || Object.getPrototypeOf(InputTodo)).call(this, props));

    _this.state = { receivedChanged: "This will update" };
  ...
  _createClass(InputTodo, [{
    key: "receiveChange",
    value: function receiveChange(v) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "component" },
          _react2.default.createElement(_input.Input, { theChanged: this.receiveChange }),
          _react2.default.createElement(
            "h1",
            null,
            "Below we render the new state in the parent, the state comes from the props of the input child above"
          ),
          _react2.default.createElement(
            "h1",
            null,
            this.state.receivedChanged
          )
        ),
        _react2.default.createElement(
          "div",
          ...
          _react2.default.createElement(
            "div",
            null,
            _react2.default.createElement(_todoApp.TodoApp, null)
          )
        )
      );
    }
...
var _exportingModules = __webpack_require__(31);

var _exportingModules2 = __webpack_require__(32);

var variasFunciones = _interopRequireWildcard(_exportingModules2);
...
var Input = exports.Input = function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    key: 'callFunction1',
    value: function callFunction1() {
      (0, _exportingModules.saluda)();(0, _exportingModules.despidete)();
      console.log("My age is: " + variasFunciones.suma(24, 5) + "The rest function is : " + variasFunciones.restar(30, 20));
      (0, _exportingModules.reallyReallyLongModuleExportName)();
    }
  }, {
    key: 'callAjax',
    value: function callAjax() {
      ...
      xhttp0.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
          console.log("te method return the following: " + xhttp0.getAllResponseHeaders() + "the status is " + this.status);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h1',
          { id: 'title' },
          'The below input is a controlled component, react is the source of truth of the input form '
        ),
        _react2.default.createElement('input', { value: this.state.input, onChange: this.handleChange }),
        _react2.default.createElement(
          'h1',
          null,
          'Below we have a call to the state new value from inside the child return render method'
        ),
        _react2.default.createElement(
          'h4',
          null,
        ...
        _react2.default.createElement(
          'button',
          { onClick: this.callFunction1 },
          'Click to call external modules functions '
        ),
        _react2.default.createElement(
          'button',
          { onClick: this.callAjax },
          'Click to call an ajax function'
        ),
        _react2.default.createElement('div', { id: 'ajax' }),
        _react2.default.createElement(
          'button',
          { onClick: this.requestXML },
          'Request artist from cd catalog'
        ),
        _react2.default.createElement('table', { id: 'demo0' })
      );
    }
  }]);
...
exports.despidete = despidete;
exports.reallyReallyLongModuleExportName = reallyReallyLongModuleExportName;
function saluda() {
  console.log("Hola soy funcion saluda desde otro módulo. ");
}

function despidete() {
  console.log("Hola soy despidete desde otro módulo. ");
}

function reallyReallyLongModuleExportName() {
  console.log("This is a long module name and is convenient to make it shorter with an alias. ");
}
...
var TodoApp = exports.TodoApp = function (_React$Component) {
  ...
  _createClass(TodoApp, [{
    ...
    key: 'handleupdate',
    value: function handleupdate(received) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(TodoList, { value: this.state.items, updateid: this.handleupdate }),
          _react2.default.createElement('input', { value: this.text, onChange: this.handleChange }),
          _react2.default.createElement(
            'button',
            null,
            'add todo item'
  ...
  _createClass(TodoList, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'ul',
        { id: 'ul' },
        this.props.value.map(function (added, index) {
          return _react2.default.createElement(
            'li',
            { id: added.id, key: added.id },
            index + 1,
            ' - ',
            added.text,
            ' ',
            _react2.default.createElement(
              'span',
              { onClick: _this3.close, className: 'X' },
              '\xD7'
            ),
            ' '
          );
...
exports.ProductTable = undefined;
...
var ProductTable = exports.ProductTable = function (_React$Component) {
  ...
  function ProductTable(props) {
    ...
    _this.state = { text: "", inStock: false, price: "", items: [] };
    component = _this;
    _this.receiveText = _this.receiveText.bind(_this);
    return _this;
  }
  ...
  _createClass(ProductTable, [{
    ...
    value: function render() {
      return _React2.default.createElement(
        'div',
        { id: 'productTable' },
        _React2.default.createElement(SearchBar, { text: this.receiveText, inStock: this.receiveStock }),
        _React2.default.createElement(Table, { items: this.state.items })
      );
    }
  }]);
...
var SearchBar = function (_React$Component2) {
  ...
  function SearchBar(props) {
    ...
    _this2.state = { text: "", inStock: false };
    _this2.handleChange = _this2.handleChange.bind(_this2);
    _this2.handleChangeStock = _this2.handleChangeStock.bind(_this2);
    return _this2;
  }
  ...
  _createClass(SearchBar, [{
    ...
    key: 'handleChangeStock',
    value: function handleChangeStock() {
    ...
    value: function render() {
      return _React2.default.createElement(
        'div',
        null,
        _React2.default.createElement('input', { type: 'text', value: this.state.text, placeholder: 'search', onChange: this.handleChange }),
        _React2.default.createElement('input', { type: 'checkbox', checked: this.state.inStock, onClick: this.handleChangeStock })
      );
    }
  }]);
    ...
    value: function render() {
      ...
      return _React2.default.createElement(
        ...
        _React2.default.createElement(
          'tbody',
          null,
          theCategories.map(function (cat, ind) {
            return _React2.default.createElement(TableCategory, { id: 'tableCategory', category: cat, items: _this4.props.items, number: ind, key: ind });
          })
        )
      );
    }
...
function TableCategory(props) {
  return _React2.default.createElement(
    ...
    _React2.default.createElement(TableItems, { category: props.category, items: props.items, id: props.number })
  );
}
function TableItems(props) {
  return _React2.default.createElement(
    _React2.default.Fragment,
    null,
    props.items.map(function (it, ind) {
      if (it.category == props.category) {
        if (it.stocked == false) {
          return _React2.default.createElement(
            'tr',
            { className: 'noStock', key: ind },
            _React2.default.createElement(
              'td',
              null,
              it.name
...
SearchBar.propTypes = {
  inStock: _propTypes2.default.bool
...
var FilterableProductTable = exports.FilterableProductTable = function (_React$Component) {
...
var SearchBar = function (_React$Component2) {
  ...
  function SearchBar(props) {
    ...
    _this2.handleInStockChange = _this2.handleInStockChange.bind(_this2);
    return _this2;
  }
    ...
    value: function render() {
      ...
      this.props.products.forEach(function (product) {
        ...
        if (product.category !== lastCategory) {
          rows.push(_react2.default.createElement(ProductCategoryRow, {
...
var ProductCategoryRow = function (_React$Component5) {
  _inherits(ProductCategoryRow, _React$Component5);
...
exports.HandlingPortals = exports.FileInput = exports.NameForm = exports.CustomTextInput = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

exports.EscogeColorAzul = EscogeColorAzul;
...
var exportedVariables = _interopRequireWildcard(_propTypes);
...
var MyComponents = {
  EscogeColor: function EscogeColor(props) {
    return _react2.default.createElement(
      ...
      'Imagina un escogeColor aqu\xED'
    );
  },
...
function TheDiv(props) {
  var number = void 0;var suma = void 0;
  if (props.number % 2 == 0) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      null,
      'the props sum is ',
      props.numeros.reduce(function (prev, act) {
        return prev + act;
      })
    )
  );
...
function EscogeColorAzul(props) {
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(MyComponents.EscogeColor, { color: 'green' }),
    _react2.default.createElement(MyComponents.Boton, null),
    _react2.default.createElement(TheDiv, { number: '30', numeros: [2, 4, 5, 6, 13] }),
    _react2.default.createElement(
      'h5',
      null,
      'la string es ',
      exportedVariables.stringToExport
    ),
    _react2.default.createElement(
      'div',
      null,
      _react2.default.createElement(
        'p',
        null,
        exportedVariables.anotherString
      )
    )
  );
}
...
var CustomTextInput = exports.CustomTextInput = function (_React$Component) {
...
var NameForm = exports.NameForm = function (_React$Component2) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          'Name:',
          _react2.default.createElement('input', { type: 'text', defaultValue: 'theValue', ref: function ref(input) {
...
var FileInput = exports.FileInput = function (_React$Component3) {
  _inherits(FileInput, _React$Component3);

  function FileInput(props) {
    _classCallCheck(this, FileInput);

    var _this5 = _possibleConstructorReturn(this, (FileInput.__proto__ || Object.getPrototypeOf(FileInput)).call(this, props));
...
var Modal = function (_React$Component4) {
  ...
  function Modal(props) {
    ...
    _this7.el = document.createElement('div');
    return _this7;
  }
...
var HandlingPortals = exports.HandlingPortals = function (_React$Component5) {
  _inherits(HandlingPortals, _React$Component5);

  function HandlingPortals(props) {
    _classCallCheck(this, HandlingPortals);

    var _this8 = _possibleConstructorReturn(this, (HandlingPortals.__proto__ || Object.getPrototypeOf(HandlingPortals)).call(this, props));

    _this8.state = { showModal: false };

    _this8.handleShow = _this8.handleShow.bind(_this8);
    _this8.handleHide = _this8.handleHide.bind(_this8);
    return _this8;
  }

  _createClass(HandlingPortals, [{
    key: 'handleShow',
...
*/
var stringToExport = "Hola soy variable string desde proptypes";
//así se exportan las variables
exports.stringToExport = stringToExport;
var anotherString = exports.anotherString = "Otra forma de exportar variables!";
